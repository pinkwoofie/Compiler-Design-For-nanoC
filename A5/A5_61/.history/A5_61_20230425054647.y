...
logical_and_expression: 
        ...
        | logical_and_expression LOGICAL_AND equality_expression
        {
            ...
            */                     // Backpatching
            $$->falselist = merge($1->falselist, $3->falselist);    // Generate falselist by merging the falselists of $1 and $4
            $$->truelist = $3->truelist;                            // Generate truelist from truelist of $4
...
logical_or_expression: 
        ...
        {
                                // Backpatching
            $$->truelist = merge($1->truelist, $3->truelist);       // Generate falselist by merging the falselists of $1 and $4
            $$->falselist = $3->falselist;                          // Generate truelist from truelist of $4
            $$->type = BOOL;                                        // Set the type of the expression to boolean
        }
        ;
