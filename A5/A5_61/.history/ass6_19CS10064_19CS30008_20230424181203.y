...
%token '[' ']' '(' PARENTHESIS_CLOSE CURLY_BRACE_OPEN CURLY_BRACE_CLOSE 
%token ARROW BITWISE_AND MULTIPLY ADD_ SUBTRACT BITWISE_NOR NOT DIVIDE MODULO 
%token LESS_THAN GREATER_THAN LESS_THAN_EQUAL GREATER_THAN_EQUAL EQUAL NOT_EQUAL BITWISE_XOR BITWISE_OR 
...
postfix_expression: 
        ...
        | postfix_expression '(' PARENTHESIS_CLOSE
        {   
        ...
        | postfix_expression '(' argument_expression_list PARENTHESIS_CLOSE
        {   
...
direct_declarator: 
        ...
        | direct_declarator '(' parameter_type_list_opt PARENTHESIS_CLOSE
        {
            $$ = $1;
...
selection_statement: 
        IF '(' expression N PARENTHESIS_CLOSE M statement N
        {
            /*
        ...
        | IF '(' expression N PARENTHESIS_CLOSE M statement N ELSE M statement N
        {
            /*
                This production rule has been augmented for control flow
            */
...
iteration_statement: 
        FOR '(' expression_statement M expression_statement N M expression N PARENTHESIS_CLOSE M statement
        {
            /*
