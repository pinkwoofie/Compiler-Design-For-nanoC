...
function_definition: 
        ...
        {
            DataType t = $1;
            cout<<"ReturnType of function "<<$2->name << " = " <<$1<<endl;
            if($1 == CHAR) returnType[$2->name] = "char";
            else if($1 == INT) returnType[$2->name] = "int";
            else returnType[$2->name] = "void";
        }
...
function_prototype:
        ...
        {
            DataType currType = $1;
            cout<<"ReturnType of function "<< " = " <<$1->name<<endl;
            int currSize = -1;
            if(currType == CHAR)
                currSize = __CHARACTER_SIZE;
            if(currType == INT)
