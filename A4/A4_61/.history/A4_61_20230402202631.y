...
postfix_expression:
					...
					|primary_expression '(' argument_expression_list_optional ')' {printf("Line No : %d) postfix_expression --> identifier\n",yylineno);}
				  	|primary_expression ARROW IDENTIFIER {printf("Line No : %d) postfix_expression --> identifier\n",yylineno);}
				  ;
