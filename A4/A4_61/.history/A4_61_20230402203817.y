...
primary_expression:
					...
					|'(' expression ')' {printf("Line No : %d) primary_expression --> string literal\n",yylineno);}
					;

postfix_expression:
					primary_expression {printf("Line No : %d) postfix_expression --> primary_expression\n",yylineno);}
					|postfix_expression '[' expression ']' {printf("Line No : %d) postfix_expression --> identifier\n",yylineno);}
					|postfix_expression '(' argument_expression_list_optional ')' {printf("Line No : %d) postfix_expression --> identifier\n",yylineno);}
				  	|postfix_expression ARROW IDENTIFIER {printf("Line No : %d) postfix_expression --> identifier\n",yylineno);}
				  ;
